...
maxIterations = 1 # number of CV results you want to see, value between 1 to 5
printPredictionToFile = False # deprecated.. should not use since we are doing CV, keep it false
algoVerbose = False
predFile = 'files/rf.25.75.predictions'#sys.argv[2];
...
for train_index, test_index in skf:
    ...
    clf = RandomForestClassifier(n_estimators=no_of_trees, verbose=algoVerbose)
