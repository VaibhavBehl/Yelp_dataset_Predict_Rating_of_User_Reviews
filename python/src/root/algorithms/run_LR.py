...
algoVerbose = False
predFile = 'files/nb.mn.25.75.predictions'#sys.argv[2]; # deprecated
useTfIdf = True # this becomes feature 3! # True INCREASES MAE(bad)
...
for train_index, test_index in skf:
    ...
    clf = linear_model.SGDClassifier(loss='log',verbose=algoVerbose,n_iter=50)
